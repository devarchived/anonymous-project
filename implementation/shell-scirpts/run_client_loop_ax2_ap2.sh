...
# ===== CONFIGURATION =====
STA_IP="192.168.2.2"                # IP of roaming STA (iperf3 server)
PORT="5201"                         # STA iperf3 server port
BITRATE="100M"                      # UDP bitrate
DURATION="60"                       # Test duration in seconds
RETRY_INTERVAL="5"                  # Time between retries
PACKET_SIZE="1474"
TEST_NUMBER="1"
SCENARIO_TYPE="AX2"                 # EHR, AX2, AX5, etc.
LOGFILE="/root/iperf3_client_ax2_ap2_${SCENARIO_TYPE}_${TEST_NUMBER}.log"
