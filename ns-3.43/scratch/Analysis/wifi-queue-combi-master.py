...
def main():
    ...
    plot_filename_th = f'../Graphs/traffic-rate/th-{out_prefix}{reliability_str}-poisson.pdf'
    ...
    plot_filename_rel = f'../Graphs/traffic-rate/rel-{out_prefix}{reliability_str}-poisson.pdf'
