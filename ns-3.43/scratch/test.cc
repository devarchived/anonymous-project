...
// Setup the EMLSR manager!!!
    ...
    for (uint8_t linkId = 0; linkId < nLinksApA; linkId++)
    {
        ...
        phyApA.AddChannel(spectrumChannel, freqRangesApA[linkId]);
    }
    ...
    NetDeviceContainer staDeviceA = wifiApA.Install(phyApA, mac, wifiStaNodes.Get(0));
    ...
    NetDeviceContainer apDeviceA = wifiApA.Install(phyApA, mac, wifiApNodes.Get(0));
    ...
    NetDeviceContainer staDeviceB = wifiApB.Install(phyApB, mac, wifiStaNodes.Get(1));
    ...
    NetDeviceContainer apDeviceB = wifiApB.Install(phyApB, mac, wifiApNodes.Get(1));
