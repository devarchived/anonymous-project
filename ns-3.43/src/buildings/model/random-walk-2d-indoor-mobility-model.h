...
#ifndef RANDOM_WALK_2D_INDOOR_MOBILITY_MODEL_H
#define RANDOM_WALK_2D_INDOOR_MOBILITY_MODEL_H
 ...
 * \ingroup mobility
 *
 * \brief 2D random walk mobility model which avoids walls.
 *
 ...
 */
class RandomWalk2dIndoorMobilityModel : public MobilityModel
{
  public:
    /**
  ...
  private:
    ...
    /**
     * Check if there is a wall between two positions (or if the nextPosition is inside a
     ...
     */
    std::pair<bool, Ptr<Wall>> IsLineClearOfWalls(Vector currentPosition,
     ...
     * \param boundaries The boundaries of the wall we will intersect
    ...
    double m_epsilon;                      //!< Tolerance for the intersection point with walls
...
#endif /* RANDOM_WALK_2D_INDOOR_MOBILITY_MODEL_H */
