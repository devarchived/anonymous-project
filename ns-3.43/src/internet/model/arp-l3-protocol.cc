                      ...
                      Address* hardwareDestination)
{
    ...
    if (entry != nullptr)
    {
        if (entry->IsExpired())
        {
            if (entry->IsDead())
            {
                NS_LOG_INFO("node=" << m_node->GetId() << ", dead entry for " << destination
            ...
            {
                NS_LOG_INFO("node=" << m_node->GetId() << ", alive entry for " << destination
                                     << " expired -- send arp request");
        ...
        else
        {
            ...
            {
                NS_LOG_INFO("node=" << m_node->GetId() << ", wait reply for " << destination
                                     << " valid -- drop previous");
            ...
            {
                NS_LOG_INFO("node=" << m_node->GetId() << ", permanent for " << destination
                                     << "valid -- send");
