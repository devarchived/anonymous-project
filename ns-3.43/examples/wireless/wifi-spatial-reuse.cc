...
main(int argc, char* argv[])
{
    ...
    NetDeviceContainer staDeviceB = wifi.Install(spectrumPhy2, mac, wifiStaNodes.Get(1));

    spectrumPhy2.Set("TxPowerStart", DoubleValue(powAp2));
    spectrumPhy2.Set("TxPowerEnd", DoubleValue(powAp2));
    spectrumPhy2.Set("CcaEdThreshold", DoubleValue(ccaEdTrAp2));
    spectrumPhy2.Set("RxSensitivity", DoubleValue(-92.0));

    mac.SetType("ns3::ApWifiMac", "Ssid", SsidValue(ssidB));
    NetDeviceContainer apDeviceB = wifi.Install(spectrumPhy2, mac, wifiApNodes.Get(1));
